...
comptime {
    @export(&function_pointers.glActiveTexture, .{ .linkage = .strong, .name = "glActiveTexture" });
    @export(&function_pointers.glAttachShader, .{ .linkage = .strong, .name = "glAttachShader" });
    @export(&function_pointers.glBindBuffer, .{ .linkage = .strong, .name = "glBindBuffer" });
    @export(&function_pointers.glBindSampler, .{ .linkage = .strong, .name = "glBindSampler" });
    @export(&function_pointers.glBindTexture, .{ .linkage = .strong, .name = "glBindTexture" });
    @export(&function_pointers.glBindVertexArray, .{ .linkage = .strong, .name = "glBindVertexArray" });
    @export(&function_pointers.glBlendEquation, .{ .linkage = .strong, .name = "glBlendEquation" });
    @export(&function_pointers.glBlendEquationSeparate, .{ .linkage = .strong, .name = "glBlendEquationSeparate" });
    @export(&function_pointers.glBlendFuncSeparate, .{ .linkage = .strong, .name = "glBlendFuncSeparate" });
    @export(&function_pointers.glBufferData, .{ .linkage = .strong, .name = "glBufferData" });
    @export(&function_pointers.glBufferSubData, .{ .linkage = .strong, .name = "glBufferSubData" });
    @export(&function_pointers.glClear, .{ .linkage = .strong, .name = "glClear" });
    @export(&function_pointers.glClearColor, .{ .linkage = .strong, .name = "glClearColor" });
    @export(&function_pointers.glCompileShader, .{ .linkage = .strong, .name = "glCompileShader" });
    @export(&function_pointers.glCreateProgram, .{ .linkage = .strong, .name = "glCreateProgram" });
    @export(&function_pointers.glCreateShader, .{ .linkage = .strong, .name = "glCreateShader" });
    @export(&function_pointers.glDeleteBuffers, .{ .linkage = .strong, .name = "glDeleteBuffers" });
    @export(&function_pointers.glDeleteProgram, .{ .linkage = .strong, .name = "glDeleteProgram" });
    @export(&function_pointers.glDeleteShader, .{ .linkage = .strong, .name = "glDeleteShader" });
    @export(&function_pointers.glDeleteTextures, .{ .linkage = .strong, .name = "glDeleteTextures" });
    @export(&function_pointers.glDeleteVertexArrays, .{ .linkage = .strong, .name = "glDeleteVertexArrays" });
    @export(&function_pointers.glDetachShader, .{ .linkage = .strong, .name = "glDetachShader" });
    @export(&function_pointers.glDisable, .{ .linkage = .strong, .name = "glDisable" });
    @export(&function_pointers.glDrawElements, .{ .linkage = .strong, .name = "glDrawElements" });
    @export(&function_pointers.glDrawElementsBaseVertex, .{ .linkage = .strong, .name = "glDrawElementsBaseVertex" });
    @export(&function_pointers.glEnable, .{ .linkage = .strong, .name = "glEnable" });
    @export(&function_pointers.glEnableVertexAttribArray, .{ .linkage = .strong, .name = "." });
    @export(&function_pointers.glGenBuffers, .{ .linkage = .strong, .name = "glGenBuffers" });
    @export(&function_pointers.glGenTextures, .{ .linkage = .strong, .name = "glGenTextures" });
    @export(&function_pointers.glGenVertexArrays, .{ .linkage = .strong, .name = "glGenVertexArrays" });
    @export(&function_pointers.glGetAttribLocation, .{ .linkage = .strong, .name = "glGetAttribLocation" });
    @export(&function_pointers.glGetIntegerv, .{ .linkage = .strong, .name = "glGetIntegerv" });
    @export(&function_pointers.glGetProgramInfoLog, .{ .linkage = .strong, .name = "glGetProgramInfoLog" });
    @export(&function_pointers.glGetProgramiv, .{ .linkage = .strong, .name = "glGetProgramiv" });
    @export(&function_pointers.glGetShaderInfoLog, .{ .linkage = .strong, .name = "glGetShaderInfoLog" });
    @export(&function_pointers.glGetShaderiv, .{ .linkage = .strong, .name = "glGetShaderiv" });
    @export(&function_pointers.glGetString, .{ .linkage = .strong, .name = "glGetString" });
    @export(&function_pointers.glGetStringi, .{ .linkage = .strong, .name = "glGetStringi" });
    @export(&function_pointers.glGetUniformLocation, .{ .linkage = .strong, .name = "glGetUniformLocation" });
    @export(&function_pointers.glIsEnabled, .{ .linkage = .strong, .name = "glIsEnabled" });
    @export(&function_pointers.glIsProgram, .{ .linkage = .strong, .name = "glIsProgram" });
    @export(&function_pointers.glLinkProgram, .{ .linkage = .strong, .name = "glLinkProgram" });
    @export(&function_pointers.glPixelStorei, .{ .linkage = .strong, .name = "glPixelStorei" });
    @export(&function_pointers.glPolygonMode, .{ .linkage = .strong, .name = "glPolygonMode" });
    @export(&function_pointers.glScissor, .{ .linkage = .strong, .name = "glScissor" });
    @export(&function_pointers.glShaderSource, .{ .linkage = .strong, .name = "glShaderSource" });
    @export(&function_pointers.glTexImage2D, .{ .linkage = .strong, .name = "glTexImage2D" });
    @export(&function_pointers.glTexParameteri, .{ .linkage = .strong, .name = "glTexParameteri" });
    @export(&function_pointers.glUniform1i, .{ .linkage = .strong, .name = "glUniform1i" });
    @export(&function_pointers.glUniformMatrix4fv, .{ .linkage = .strong, .name = "glUniformMatrix4fv" });
    @export(&function_pointers.glUseProgram, .{ .linkage = .strong, .name = "glUseProgram" });
    @export(&function_pointers.glVertexAttribPointer, .{ .linkage = .strong, .name = "glVertexAttribPointer" });
    @export(&function_pointers.glViewport, .{ .linkage = .strong, .name = "glViewport" });
    @export(&function_pointers.glEnableVertexAttribArray, .{ .linkage = .strong, .name = "glEnableVertexAttribArray" });
}
